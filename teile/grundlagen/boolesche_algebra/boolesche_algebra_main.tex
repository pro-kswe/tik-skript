...
\begin{exercise}
Wie in der Mathematik gibt es auch in der booleschen Algebra verschiedene \say{Rechengesetze}. In dieser Aufgabe sollen Sie erste Gesetzmässigkeiten entdecken. Übertragen Sie dazu die booleschen Formeln in die entsprechenden Logikgatter, Eingänge und Ausgänge. Verwenden Sie dazu Logicly. Anstelle der Schalter können Sie auch direkt einen Eingang mit \num{0} oder \num{1} verwenden. Füllen Sie dann die Tabelle aus.
